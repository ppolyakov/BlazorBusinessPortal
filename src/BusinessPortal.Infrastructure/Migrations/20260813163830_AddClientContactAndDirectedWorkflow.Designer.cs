...
namespace BusinessPortal.Infrastructure.Migrations
{
    ...
    [Migration("20260813163830_AddClientContactAndDirectedWorkflow")]
    partial class AddClientContactAndDirectedWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessPortal.Domain.TimeEntryActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OrganizationId", "TimeEntryId", "OccurredAtUtc");

                    b.ToTable("TimeEntryActivities");
                });
            ...
            modelBuilder.Entity("BusinessPortal.Domain.TimeEntryActivity", b =>
                {
                    ...
                    b.HasOne("BusinessPortal.Domain.TimeEntry", null)
                        .WithMany()
