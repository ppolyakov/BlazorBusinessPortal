        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    BudgetHours = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeEntries_AspNetUsers_ReviewedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_OrganizationId_IsActive",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEntries_OrganizationId_EntityType_Action",
                table: "AuditEntries",
                columns: new[] { "OrganizationId", "EntityType", "Action" });

            migrationBuilder.CreateIndex(
                name: "IX_AuditEntries_OrganizationId_OccurredAtUtc",
                table: "AuditEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_OrganizationId_ClientId_Status",
                table: "Projects",
                columns: new[] { "OrganizationId", "ClientId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_OrganizationId_ProjectId_WorkDate",
                table: "TimeEntries",
                columns: new[] { "OrganizationId", "ProjectId", "WorkDate" });

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_OrganizationId_Status_SubmittedAtUtc",
                table: "TimeEntries",
                columns: new[] { "OrganizationId", "Status", "SubmittedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_OrganizationId_UserId_WorkDate",
                table: "TimeEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_ReviewedByUserId",
                table: "TimeEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkItems_OrganizationId_AssignedToUserId_DueDate",
                table: "WorkItems",
                columns: new[] { "OrganizationId", "AssignedToUserId", "DueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkItems_OrganizationId_ProjectId_Status",
                table: "WorkItems",
